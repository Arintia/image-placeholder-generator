...
function App() {
  ...
  return (
    <main className="w-screen h-screen flex items-center justify-center relative bg-gray-100 dark:bg-gray-800">
      <aside>
      ...
      <div className="container flex flex-col items-center justify-center">
        ...
        <div className="relative z-0 mb-3 w-1/4 group">
          <input type="number" id="width" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div className="relative z-0 mb-3 w-1/4 group">
          <input type="number" id="height" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div className="relative z-0 mb-3 w-1/4 group">
          <input type="text" id="caption" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
