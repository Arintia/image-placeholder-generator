...
function App() {
  ...
  return (
    <React.Fragment>
      <main className="w-screen h-screen flex flex-col items-center justify-center relative pb-36 lg:pb-0 bg-gray-100 dark:bg-gray-800">
        <aside>
          <label htmlFor="theme-switcher" className="swap swap-rotate absolute right-2 lg:right-5 top-12 md:top-5">
